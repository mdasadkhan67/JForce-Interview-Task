      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            onChange={handleChange}
            onBlur={handleBlur}
            className={`w-full rounded border p-2 outline-none transition ${errors.password && touched.password
              ? 'border-red-500 focus:border-red-500 focus:ring-red-200'
              : 'border-gray-300 focus:border-blue-500'
              }`}
        ...
        <div className="mb-4">
          ...
          <input
            ...
            onChange={handleChange}
            onBlur={handleBlur}
            className={`w-full rounded border p-2 outline-none transition ${errors.confirmPassword && touched.confirmPassword
              ? 'border-red-500 focus:border-red-500 focus:ring-red-200'
              : 'border-gray-300 focus:border-blue-500'
              }`}
